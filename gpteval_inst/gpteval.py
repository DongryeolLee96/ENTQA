                ...
                if 'inst{}_{}'.format(args.inference_type,model_type) in d.keys():
                    ...
                    try:
                        if args.extracted=='true':
                            instzero, prompt=insteval(d['answer_{}_extracted'.format(model_type)], answer_set, d['question'], d['ans_type'], inst_model=args.inst_model, few_shot_type=args.few_shot_type,few_shot_dir= args.few_shot_file_dir,eval_type=args.inference_type)
                            ...
                            instzero, prompt=insteval(d['answer_{}'.format(model_type)], answer_set, d['question'], d['ans_type'], inst_model=args.inst_model, few_shot_type=args.few_shot_type,few_shot_dir= args.few_shot_file_dir,eval_type=args.inference_type)
